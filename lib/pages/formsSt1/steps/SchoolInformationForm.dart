...
class SchoolInformationForm extends StatefulWidget {
  ...
  @override
  _SchoolInformationFormState createState() => _SchoolInformationFormState();
}

class _SchoolInformationFormState extends State<SchoolInformationForm> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              children: [
                _buildTextFormField(
                  label: "Référence Juridique (Arrêté d'agrément/d'autorisation)",
            ...
            _buildSection(
              ...
              children: [
                ...
                _buildYesNoRadio(
                  label: "Le Chef d'Etablissement a-t-il reçu une formation continue ?",
                  key: "chef_formation",
                ),
                _buildYesNoRadio(
                  label: "Le Chef d'Etablissement a-t-il été coté Positivement ?",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildCompactRadioOption(key: key, value: "Oui", color: Colors.green),
              const SizedBox(width: 16),
              _buildCompactRadioOption(key: key, value: "Non", color: Colors.red),
            ],
          ),
        ],
      ),
