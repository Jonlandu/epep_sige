...
import 'package:epsp_sige/pages/formsSt2/steps/SallesEffectifsStep.dart';
...
class DynamiqueMultiStepFormST2 extends StatefulWidget {
  const DynamiqueMultiStepFormST2({super.key});
...
class _DynamiqueMultiStepFormST2State extends State<DynamiqueMultiStepFormST2> {
  ...
  final List<Map<String, dynamic>> _stepsData = [
    ...
    {'title': 'Historique', 'icon': Icons.history, 'color': Colors.green},
    //{'title': 'Enfant', 'icon': Icons.child_care, 'color': Colors.indigo},
  ...
  void _scrollToCurrentStep() {
    if (_scrollController.hasClients) {
      ...
      // Clamp the scroll offset to ensure it stays within bounds
  ...
  Widget _buildCurrentStepContent() {
    switch (_currentStep) {
      ...
      //case 7: return (formData: formData, formKey: _stepFormKeys[0]);
      case 7: return ThemesTransversauxStep(formData: formData, formKey: _stepFormKeys[7]);
